...
import com.bhplanine.user.graduationproject.Bjelasnica.jsonweather.WeatherAdapter;
...
public class Weather extends Fragment {
    ...
    private void buildRecyclerView(View v) {
        WeatherAdapter recyclerWeather = new WeatherAdapter(day, getContext(), weatherFont);
